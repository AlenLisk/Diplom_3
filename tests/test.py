...
class TestForgotPasswordPage:
    ...
    def test_set_email_and_click_button_restore(self, forgot_password_page):
        forgot_password_page.go_to_site(Urls.FORGOT_PASSWORD)
        value = forgot_password_page.set_email()
        forgot_password_page.click_button_restore()
        forgot_password_page.find_title_restore_password()
        time.sleep(1)
    ...
    def test_backlight_field_password(self, forgot_password_page):
        forgot_password_page.go_to_site(Urls.FORGOT_PASSWORD)
        forgot_password_page.set_email()
        forgot_password_page.click_button_restore()
        forgot_password_page.find_title_restore_password()
        forgot_password_page.click_button_show_password()
        field = forgot_password_page.find_active_field_password()
